// src/pages/SavedListingsPage.jsx
...
const SavedListingsPage = () => {
  ...
  const categories = [
    ...new Set(savedListings.map((item) => item.category).filter(Boolean)),
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-manrope flex flex-col">
      ...
      <main className="flex-grow md:mt-10 mt-15 max-w-7xl mx-auto px-4 sm:px-6 py-6 md:py-10">
        ...
        {/* Profile Summary - Only show if user is logged in */}
          ...
          <div className="bg-gradient-to-r from-[#00d1ff] to-[#00d37f] rounded-2xl p-6 mb-8 text-white">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full overflow-hidden border-4 border-white bg-gray-200 flex items-center justify-center">
                  {userProfile?.image ? (
                    <img
