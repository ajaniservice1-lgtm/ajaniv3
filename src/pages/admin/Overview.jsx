...
const Overview = () => {
  ...
  const [systemPrompt, setSystemPrompt] = useState(
    `You are AJANI Assistant, a helpful AI for the AJANI service marketplace.
...
Response Format: Keep responses under 3 sentences when possible.`,
  ...
  const handleCreateListing = () => {
    // Prepare the final data structure based on category
    let listingData = {
    ...
    if (listingCategory === "restaurant") {
      listingData.details = {
        yearsOfOperation: listingForm.details?.yearsOfOperation || 0,
        seatingCapacity: listingForm.details?.seatingCapacity || 0,
        cuisineType: listingForm.details?.cuisineType || [],
        operatingDays: listingForm.details?.operatingDays || [],
        dineInService: listingForm.details?.dineInService || false,
        takeawayService: listingForm.details?.takeawayService || false,
        deliveryService: listingForm.details?.deliveryService || false,
      };
    } else if (listingCategory === "hotel") {
      listingData.details = {
        roomTypes: listingForm.details?.roomTypes || [],
      };
    } else if (listingCategory === "shortlet") {
      listingData.details = {
        numberOfRooms: listingForm.details?.numberOfRooms || 1,
        bedType: listingForm.details?.bedType || "",
        pricePerNight: listingForm.details?.pricePerNight || 0,
        pricePerWeek: listingForm.details?.pricePerWeek || 0,
        minimumStayDuration:
          listingForm.details?.minimumStayDuration || "1 night",
        maximumGuestCapacity: listingForm.details?.maximumGuestCapacity || 2,
        houseRules: listingForm.details?.houseRules || "",
        refundPolicy: listingForm.details?.refundPolicy || "",
        googleMapsLink: listingForm.details?.googleMapsLink || "",
        bathroomsAvailable: listingForm.details?.bathroomsAvailable || false,
        kitchenAvailable: listingForm.details?.kitchenAvailable || false,
        livingRoomAvailable: listingForm.details?.livingRoomAvailable || false,
        balconyAvailable: listingForm.details?.balconyAvailable || false,
        airConditioning: listingForm.details?.airConditioning || false,
        wifiAvailable: listingForm.details?.wifiAvailable || false,
        smartTV: listingForm.details?.smartTV || false,
        securityAvailable: listingForm.details?.securityAvailable || false,
        parkingAvailable: listingForm.details?.parkingAvailable || false,
        cleaningService: listingForm.details?.cleaningService || false,
        laundryService: listingForm.details?.laundryService || false,
        swimmingPool: listingForm.details?.swimmingPool || false,
        gym: listingForm.details?.gym || false,
      };
    } else if (listingCategory === "services") {
      listingData.details = {
        serviceCategory:
          listingForm.details?.serviceCategory || "General Services",
        businessDescription:
          listingForm.details?.businessDescription ||
          "Professional service provider.",
        yearsOfExperience: listingForm.details?.yearsOfExperience || 0,
        cacRegistered: listingForm.details?.cacRegistered || false,
        cacNumber: listingForm.details?.cacNumber || "",
        listOfServices: listingForm.details?.listOfServices || [],
        pricingRange: listingForm.details?.pricingRange || {
          priceFrom: 0,
          priceTo: 0,
        },
        operatingHours:
          listingForm.details?.operatingHours || "09:00 AM - 05:00 PM",
        businessPhotos: listingForm.details?.businessPhotos || [],
        businessLogo: listingForm.details?.businessLogo || "",
      };
    } else if (listingCategory === "event") {
      listingData.details = {
        hallDescription:
          listingForm.details?.hallDescription ||
          "Spacious event hall for all occasions.",
        numberOfHalls: listingForm.details?.numberOfHalls || 1,
        hallType: listingForm.details?.hallType || "indoor",
        minGuestCapacity: listingForm.details?.minGuestCapacity || 50,
        maxGuestCapacity: listingForm.details?.maxGuestCapacity || 500,
        parkingCapacity: listingForm.details?.parkingCapacity || 20,
        airConditioning: listingForm.details?.airConditioning || true,
        powerSupplyType:
          listingForm.details?.powerSupplyType || "Industrial Generator",
        stageAvailable: listingForm.details?.stageAvailable || true,
        lightingAvailable: listingForm.details?.lightingAvailable || true,
        soundSystem: listingForm.details?.soundSystem || true,
        changingRoom: listingForm.details?.changingRoom || true,
        toiletsAvailable: listingForm.details?.toiletsAvailable || true,
        securityAvailable: listingForm.details?.securityAvailable || true,
        decorationsAllowed: listingForm.details?.decorationsAllowed || true,
        cateringOption: listingForm.details?.cateringOption || "both",
        supportedEventTypes: listingForm.details?.supportedEventTypes || [],
        priceRange: listingForm.details?.priceRange || {
          priceFrom: 0,
          priceTo: 0,
        },
        minimumBookingDuration:
          listingForm.details?.minimumBookingDuration || "4 hours",
        requiredDeposit: listingForm.details?.requiredDeposit || 50,
        refundPolicy:
          listingForm.details?.refundPolicy || "Non-refundable deposit",
        hallPhotos: listingForm.details?.hallPhotos || [],
        eventSetupPhotos: listingForm.details?.eventSetupPhotos || [],
        googleMapsLink:
          listingForm.details?.googleMapsLink || "https://maps.google.com",
      };
    }
    ...
    <div className="flex min-h-screen bg-gray-50 text-gray-800">
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex justify-between items-center py-1 md:py-2">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      <div className="w-10 h-5 md:w-12 md:h-6 bg-gray-300 rounded-full peer peer-checked:bg-green-600 transition-all"></div>
                      <div
                        className={`absolute left-0.5 md:left-1 top-0.5 md:top-1 w-4 h-4 bg-white rounded-full transition-all ${featureToggles.chatbot ? "translate-x-5 md:translate-x-6" : ""}`}
                      ></div>
                    </label>
                  </div>
                  <div className="flex justify-between items-center py-1 md:py-2">
              ...
              <div className="bg-white p-4 md:p-6 rounded-xl shadow-md">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4">
                  {aiUsageStats.map((stat, index) => (
                    <div
                      key={index}
                      className="bg-gray-50 p-3 md:p-4 rounded-lg flex flex-col items-center justify-center"
                    >
                      <div className="text-lg md:text-2xl font-bold text-gray-900">
                        {stat.value}
                      </div>
                      <span className="font-semibold text-xs md:text-sm text-gray-600 text-center">
                        {stat.label}
                      </span>
                    </div>
                  ))}
                ...
                <div className="space-y-3 md:space-y-4">
                  {securityStatus.map((status, index) => (
                    ...
                    >
                      <div className="flex items-center">
                        <div
                          className={`w-2 h-2 md:w-3 md:h-3 rounded-full mr-2 md:mr-3 ${status.indicator === "online" ? "bg-green-500" : "bg-yellow-500"}`}
                        ></div>
                        <span className="text-sm md:text-base">
                          {status.label}
                        </span>
      ...
      {activeModal === "createListingModal" && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 md:p-4 overflow-y-auto">
          <div
            ref={modalRef}
            className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] md:max-h-[95vh] overflow-y-auto"
          >
              ...
              <div className="mb-6 md:mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 md:gap-3">
                  ...
                  >
                    <FontAwesomeIcon
                      icon={faUtensils}
                      className="text-lg md:text-xl mb-2 text-blue-600"
                    />
                    <span className="font-semibold text-xs md:text-sm text-center">
                      Restaurant
                    </span>
                  ...
                  >
                    <FontAwesomeIcon
                      icon={faHotel}
                      className="text-lg md:text-xl mb-2 text-green-600"
                    />
                    <span className="font-semibold text-xs md:text-sm text-center">
                      Hotel
                    </span>
                  ...
                  >
                    <FontAwesomeIcon
                      icon={faHome}
                      className="text-lg md:text-xl mb-2 text-purple-600"
                    />
                    <span className="font-semibold text-xs md:text-sm text-center">
                      Shortlet
                    </span>
                  ...
                  <button
                    onClick={() => setListingCategory("services")}
                    className={`p-3 md:p-4 border-2 rounded-lg flex flex-col items-center justify-center transition-all ${listingCategory === "services" ? "border-blue-600 bg-blue-50" : "border-gray-300 hover:border-blue-400"}`}
                  >
                    <FontAwesomeIcon
                      icon={faWrench}
                      className="text-lg md:text-xl mb-2 text-orange-600"
                    />
                    <span className="font-semibold text-xs md:text-sm text-center">
                      Services
                    </span>
                  ...
                  <button
                    ...
                    className={`p-3 md:p-4 border-2 rounded-lg flex flex-col items-center justify-center transition-all ${listingCategory === "event" ? "border-blue-600 bg-blue-50" : "border-gray-300 hover:border-blue-400"}`}
                  >
                    <FontAwesomeIcon
                      icon={faCalendar}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="69558890c263664d295678ab">
                        Ajani AI (vendor@ajani.ai)
                      </option>
                    </select>
                  </div>
                      ...
                      onChange={(e) =>
                        setListingForm({
                          ...
                          location: {
                            ...listingForm.location,
                            geolocation: {
                              ...listingForm.location?.geolocation,
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setListingForm({
                          ...listingForm,
                          contactInformation: {
                            ...listingForm.contactInformation,
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setListingForm({
                            ...
                            details: {
                              ...listingForm.details,
                              yearsOfOperation: parseInt(e.target.value),
                            },
                          })
                        }
                      />
                      ...
                      <div className="flex flex-wrap gap-2 mb-2">
                        {[
                          ...
                          <button
                            ...
                            onClick={() => {
                              const current =
                                listingForm.details?.cuisineType || [];
                              if (current.includes(cuisine)) {
                                setListingForm({
                                  ...listingForm,
                                  details: {
                                    ...listingForm.details,
                                    cuisineType: current.filter(
                                      (c) => c !== cuisine,
                                    ),
                                  },
                                });
                        ...
                        {[
                          ...
                          >
                            <input
                              ...
                              className="mr-2"
                              checked={(
                                listingForm.details?.operatingDays || []
                              ).includes(day)}
                              onChange={(e) => {
                                const current =
                                  listingForm.details?.operatingDays || [];
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4">
                        <label className="flex items-center text-sm md:text-base">
                          <input
                            ...
                            className="mr-2"
                            checked={
                              listingForm.details?.dineInService || false
                            }
                            onChange={(e) =>
                              setListingForm({
                                ...listingForm,
                                details: {
                                  ...listingForm.details,
                                  dineInService: e.target.checked,
                                },
                              })
                            }
                          />
                        ...
                        <label className="flex items-center text-sm md:text-base">
                          <input
                            ...
                            className="mr-2"
                            checked={
                              listingForm.details?.takeawayService || false
                            }
                            onChange={(e) =>
                              setListingForm({
                                ...listingForm,
                                details: {
                                  ...listingForm.details,
                                  takeawayService: e.target.checked,
                                },
                              })
                            }
                          />
                        ...
                        <label className="flex items-center text-sm md:text-base">
                          <input
                            ...
                            className="mr-2"
                            checked={
                              listingForm.details?.deliveryService || false
                            }
                            onChange={(e) =>
                              setListingForm({
                                ...listingForm,
              ...
              {listingCategory === "hotel" && (
                <div className="mb-6 md:mb-8">
                  ...
                  <div className="mb-4 md:mb-6">
                    ...
                    {(listingForm.details?.roomTypes || []).map(
                      (room, index) => (
                        <div
                          key={index}
                          className="bg-gray-50 p-3 md:p-4 rounded-lg mb-3 md:mb-4 border border-gray-200"
                        >
                          <div className="flex justify-between items-center mb-2 md:mb-3">
                            <h6 className="font-medium text-gray-800 text-sm md:text-base">
                              Room Type #{index + 1}
                            </h6>
                            <button
                              type="button"
                              onClick={() => {
                                const current =
                                  listingForm.details?.roomTypes || [];
                                setListingForm({
                                  ...listingForm,
                                  details: {
                                    ...listingForm.details,
                                    roomTypes: current.filter(
                                      (_, i) => i !== index,
                                    ),
                                  },
                                });
                                  ...
                                  >
                                    <input
                                      ...
                                      onChange={(e) => {
                                        ...
                                        const roomAmenities =
                                          current[index].amenities || [];
                                        if (e.target.checked) {
                                          roomAmenities.push(amenity);
                                        } else {
                                          const indexToRemove =
                                            roomAmenities.indexOf(amenity);
                                          if (indexToRemove > -1) {
                                            roomAmenities.splice(
                                              indexToRemove,
                                              1,
                                            );
                                          }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setListingForm({
                            ...
                            details: {
                              ...listingForm.details,
                              pricePerWeek: parseInt(e.target.value),
                            },
                          })
                        }
                      />
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setListingForm({
                            ...
                            details: {
                              ...listingForm.details,
                              minimumStayDuration: e.target.value,
                            },
                          })
                        }
                      />
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setListingForm({
                            ...
                            details: {
                              ...listingForm.details,
                              maximumGuestCapacity: parseInt(e.target.value),
                            },
                          })
                        }
                      />
                    ...
                    <div className="md:col-span-2 space-y-2 md:space-y-3">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-3">
                        {[
                          {
                            label: "Bathrooms Available",
                            key: "bathroomsAvailable",
                          },
                          {
                          ...
                          {
                            label: "Living Room Available",
                            key: "livingRoomAvailable",
                          },
                          {
                            label: "Balcony Available",
                            key: "balconyAvailable",
                          },
                          ...
                          >
                            <input
                              ...
                              className="mr-2"
                              checked={
                                listingForm.details?.[amenity.key] || false
                              }
                              onChange={(e) =>
                                setListingForm({
                                  ...listingForm,
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                    <div>
                      ...
                      <select
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        value={
                          listingForm.details?.serviceCategory ||
                          "General Services"
                        }
                        onChange={(e) =>
                          setListingForm({
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="e.g., 3"
                        value={listingForm.details?.yearsOfExperience || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        value={listingForm.details?.businessDescription || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                    ...
                    <div className="flex items-center space-x-4">
                      <label className="flex items-center text-sm md:text-base">
                        <input
                          type="checkbox"
                          className="mr-2"
                          checked={listingForm.details?.cacRegistered || false}
                          onChange={(e) =>
                            setListingForm({
                              ...listingForm,
                              details: {
                                ...listingForm.details,
                                cacRegistered: e.target.checked,
                              },
                            })
                          }
                        />
                      ...
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          value={listingForm.details?.cacNumber || ""}
                          onChange={(e) =>
                            setListingForm({
                              ...listingForm,
                              details: {
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={listingForm.details?.operatingHours || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="flex flex-wrap gap-2 mb-2">
                        {[
                          ...
                          <button
                            ...
                            onClick={() => {
                              const current =
                                listingForm.details?.listOfServices || [];
                              if (current.includes(service)) {
                                setListingForm({
                                  ...listingForm,
                                  details: {
                                    ...listingForm.details,
                                    listOfServices: current.filter(
                                      (s) => s !== service,
                                    ),
                                  },
                                });
                                ...
                                setListingForm({
                                  ...
                                  details: {
                                    ...listingForm.details,
                                    listOfServices: [...current, service],
                                  },
                                });
                              }
                            }}
                            className={`px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm ${(listingForm.details?.listOfServices || []).includes(service) ? "bg-blue-100 text-blue-800 border border-blue-300" : "bg-gray-100 text-gray-800 border border-gray-300"}`}
                          >
                            {service}
                          </button>
                        ))}
                      ...
                      <input
                        type="text"
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="Add custom service (press Enter to add)"
                        onKeyDown={(e) => {
                          if (e.key === "Enter" && e.target.value.trim()) {
                            e.preventDefault();
                            const current =
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          listingForm.details?.pricingRange?.priceFrom || ""
                        }
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              pricingRange: {
                                ...listingForm.details?.pricingRange,
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={listingForm.details?.pricingRange?.priceTo || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={listingForm.details?.businessLogo || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                ...
                <div className="mb-6 md:mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base min-h-16 md:min-h-20"
                        placeholder="Describe your event hall, facilities, and ambiance"
                        value={listingForm.details?.hallDescription || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              hallDescription: e.target.value,
                            },
                          })
                        }
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="e.g., 1"
                        value={listingForm.details?.numberOfHalls || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              numberOfHalls: parseInt(e.target.value),
                            },
                          })
                        }
                      />
                    ...
                    <div>
                      ...
                      <select
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        value={listingForm.details?.hallType || "indoor"}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="e.g., 50"
                        value={listingForm.details?.minGuestCapacity || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              minGuestCapacity: parseInt(e.target.value),
                            },
                          })
                        }
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="e.g., 500"
                        value={listingForm.details?.maxGuestCapacity || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              maxGuestCapacity: parseInt(e.target.value),
                            },
                          })
                        }
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="e.g., 20"
                        value={listingForm.details?.parkingCapacity || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              parkingCapacity: parseInt(e.target.value),
                            },
                          })
                        }
                      />
                    ...
                    <div>
                      ...
                      <select
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        value={
                          listingForm.details?.powerSupplyType ||
                      ...
                      >
                        <option value="Industrial Generator">
                          Industrial Generator
                        </option>
                        <option value="PHCN Only">PHCN Only</option>
                    ...
                    <div>
                      ...
                      <select
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        value={listingForm.details?.cateringOption || "both"}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              cateringOption: e.target.value,
                            },
                          })
                        }
                      >
                        <option value="provided">Provided by venue</option>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="flex flex-wrap gap-2 mb-2">
                        {[
                          ...
                          <button
                            ...
                            onClick={() => {
                              const current =
                                listingForm.details?.supportedEventTypes || [];
                              if (current.includes(eventType)) {
                                setListingForm({
                                  ...listingForm,
                                  details: {
                                    ...listingForm.details,
                                    supportedEventTypes: current.filter(
                                      (et) => et !== eventType,
                                    ),
                                  },
                                });
                            ...
                            className={`px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm ${(listingForm.details?.supportedEventTypes || []).includes(eventType) ? "bg-blue-100 text-blue-800 border border-blue-300" : "bg-gray-100 text-gray-800 border border-gray-300"}`}
                          >
                            {eventType}
                          </button>
                        ))}
                      ...
                      <input
                        type="text"
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="Add custom event type (press Enter to add)"
                        onKeyDown={(e) => {
                          if (e.key === "Enter" && e.target.value.trim()) {
                            e.preventDefault();
                            const current =
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={listingForm.details?.priceRange?.priceFrom || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              priceRange: {
                                ...listingForm.details?.priceRange,
                                priceFrom: parseInt(e.target.value) || 0,
                              },
                            },
                          })
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={listingForm.details?.priceRange?.priceTo || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          listingForm.details?.minimumBookingDuration || ""
                        }
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              minimumBookingDuration: e.target.value,
                            },
                          })
                        }
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="e.g., 50"
                        value={listingForm.details?.requiredDeposit || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
                            details: {
                              ...listingForm.details,
                              requiredDeposit: parseInt(e.target.value),
                            },
                          })
                        }
                      />
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="e.g., Non-refundable deposit"
                        value={listingForm.details?.refundPolicy || ""}
                        onChange={(e) =>
                          setListingForm({
                            ...listingForm,
              ...
              <div className="mb-6 md:mb-8">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 md:p-8 text-center">
                  <div className="mb-3 md:mb-4">
                    <FontAwesomeIcon
                      icon={faCloudUploadAlt}
                      className="text-3xl md:text-4xl text-blue-500 mb-2 md:mb-3"
                    />
                  ...
                  <label
                    htmlFor="imageUpload"
                    className="px-4 py-2 md:px-6 md:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all cursor-pointer inline-block text-sm md:text-base"
                  >
                    Select Images
                  </label>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-4">
                  ...
                  <div className="text-xs md:text-sm text-gray-600 max-w-md mt-3 md:mt-0">
                    <p className="mb-1 font-medium">
                      Form will save data in the following structure:
                    </p>
            ...
            <div className="flex justify-end gap-2 md:gap-3 p-4 md:p-6 border-t sticky bottom-0 bg-white z-10">
              <button
                onClick={closeModal}
                className="px-3 py-2 md:px-5 md:py-2 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition-all text-sm md:text-base"
              >
                Cancel
              </button>
              <button
          ...
          >
            ...
            <div className="p-4 md:p-6">
              ...
              <p className="text-sm md:text-base">
                Existing bookings will remain in their current state.
              </p>
            </div>
            <div className="flex justify-end gap-2 md:gap-3 p-4 md:p-6 border-t">
              <button
              ...
              <button
                ...
                className="px-3 py-2 md:px-5 md:py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all text-sm md:text-base"
              >
                Stop All Bookings
              </button>
            </div>
            ...
            <div className="p-4 md:p-6">
              ...
              <div className="space-y-2 md:space-y-3 mb-4 md:mb-6">
                {[
                  ...
                  "Vendors Data (0 records)",
                  "Listings Data (0 records)",
                  "Booking History (0 records)",
                  "Messages (0 records)",
