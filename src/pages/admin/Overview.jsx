...
Response Format: Keep responses under 3 sentences when possible.`);
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-gray-800">
      ...
      {/* Main Content */}
      <div className={`flex-1 ${sidebarCollapsed ? 'ml-20' : 'ml-64'} p-8 transition-all duration-300`}>
        
        {/* Dashboard Page */}
        {currentPage === 'dashboard' && (
          <div>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 pb-6 border-b">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 md:mb-0">Super Admin Dashboard</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex justify-between items-center mb-6 pb-4 border-b">
                  ...
                  <FontAwesomeIcon icon={faSlidersH} className="text-blue-600" />
                </div>
                  ...
                  {Object.entries(featureToggles).map(([key, value]) => (
                    <div key={key} className="flex justify-between items-center py-3 border-b last:border-b-0">
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        <div className={`absolute left-1 top-1 w-4 h-4 bg-white rounded-full transition-all ${value ? 'translate-x-6' : ''}`}></div>
                      </label>
                    </div>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {overrideActions.map((action, index) => (
                  <button
                    ...
                    className={`p-4 bg-white border-2 rounded-lg flex flex-col items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all ${action.danger ? 'border-red-300 hover:bg-red-600 hover:border-red-600' : 'border-gray-300'}`}
                  >
                    <FontAwesomeIcon icon={action.icon} className="text-2xl mb-3" />
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {quickActions.map((action, index) => (
                    ...
                    >
                      <FontAwesomeIcon icon={action.icon} className="text-2xl text-blue-600 mb-2" />
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="p-4 text-left font-semibold text-gray-900">ID</th>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <button className="p-4 bg-white border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all">
                  ...
                  <span className="font-semibold text-center">Reset Passwords</span>
                </button>
                <button className="p-4 bg-white border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all">
                  <FontAwesomeIcon icon={faUserSlashSolid} className="text-2xl mb-3" />
                  <span className="font-semibold text-center">Suspend Users</span>
                </button>
                <button className="p-4 bg-white border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all">
                  <FontAwesomeIcon icon={faDownload} className="text-2xl mb-3" />
                  <span className="font-semibold text-center">Export All Data</span>
                </button>
                <button className="p-4 bg-white border-2 border-red-300 rounded-lg flex flex-col items-center justify-center hover:bg-red-600 hover:text-white hover:border-red-600 transition-all">
                  ...
                  <span className="font-semibold text-center">Delete Users</span>
                </button>
              </div>
            </div>
          </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="p-4 text-left font-semibold text-gray-900">ID</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Vendor Name</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Owner</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Category</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Listings</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Status</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Approved</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="p-4 text-left font-semibold text-gray-900">ID</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Title</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Vendor</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Category</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Price</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Status</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Featured</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {sampleData.listings.map((listing, index) => (
                      <tr key={index} className="hover:bg-blue-50 border-b last:border-b-0">
                        ...
                        <td className="p-4">
                          {listing.featured && <FontAwesomeIcon icon={faStar} className="text-yellow-400" />}
                        </td>
                        <td className="p-4">
                          <div className="flex gap-2">
                            <button className="w-8 h-8 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all">
        ...
        {currentPage === 'bookings' && (
          <div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="bg-blue-600 text-white p-5 flex flex-col md:flex-row justify-between items-start md:items-center">
                <h3 className="text-lg font-semibold mb-4 md:mb-0">Recent Booking Requests</h3>
                <input
                  type="text"
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="p-4 text-left font-semibold text-gray-900">Vendor</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Service</th>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {aiProviders.map((provider) => (
                  <button
                    ...
                    className={`p-4 border-2 rounded-lg flex items-center justify-center gap-3 transition-all ${aiProvider === provider.id ? 'border-blue-600 bg-blue-50' : 'border-gray-300'}`}
                  >
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2">
                    <div className="flex items-center">
                      <FontAwesomeIcon icon={faPowerOff} className="text-gray-500 mr-3" />
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      />
                      <div className="w-12 h-6 bg-gray-300 rounded-full peer peer-checked:bg-green-600 transition-all"></div>
                      <div className={`absolute left-1 top-1 w-4 h-4 bg-white rounded-full transition-all ${featureToggles.chatbot ? 'translate-x-6' : ''}`}></div>
                    </label>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <div className="flex items-center">
                      <FontAwesomeIcon icon={faVolumeUp} className="text-gray-500 mr-3" />
                  ...
                  <div className="flex justify-between items-center py-2">
                    <div className="flex items-center">
                      <FontAwesomeIcon icon={faBan} className="text-gray-500 mr-3" />
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {aiUsageStats.map((stat, index) => (
                    <div key={index} className="bg-gray-50 p-4 rounded-lg flex flex-col items-center justify-center">
                      <div className="text-2xl font-bold text-gray-900">{stat.value}</div>
                      <span className="font-semibold text-sm text-gray-600 text-center">{stat.label}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {systemTasks.map((task, index) => (
                  ...
                  >
                    <FontAwesomeIcon icon={task.icon} className="text-2xl mb-3" />
                    <span className="font-semibold text-center">{task.label}</span>
                  </button>
                ))}
              </div>
            </div>
        ...
        {currentPage === 'security' && (
          <div>
                ...
                <div className="space-y-4">
                  {securityStatus.map((status, index) => (
                    <div key={index} className="flex justify-between items-center py-2">
                      <div className="flex items-center">
                        <div className={`w-3 h-3 rounded-full mr-3 ${status.indicator === 'online' ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
                        <span>{status.label}</span>
                      </div>
                      <div className="font-semibold text-sm">{status.value}</div>
                    </div>
                  ))}
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {auditSummary.map((item, index) => (
                    <div key={index} className="bg-gray-50 p-4 rounded-lg flex flex-col items-center justify-center">
                      ...
                      <span className="font-semibold text-sm text-gray-600 text-center">{item.label}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="bg-blue-600 text-white p-5 flex flex-col md:flex-row justify-between items-start md:items-center">
                <h3 className="text-lg font-semibold mb-4 md:mb-0">Recent Audit Logs</h3>
                <input
                  type="text"
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="p-4 text-left font-semibold text-gray-900">Timestamp</th>
                      <th className="p-4 text-left font-semibold text-gray-900">User</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Action</th>
                      <th className="p-4 text-left font-semibold text-gray-900">IP Address</th>
                      <th className="p-4 text-left font-semibold text-gray-900">Details</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex justify-between items-center mb-6 pb-4 border-b">
                  ...
                  <FontAwesomeIcon icon={faCloudDownloadAlt} className="text-blue-600" />
                </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="space-y-4">
                {databaseInfo.map((info, index) => (
                  <div key={index} className="flex justify-between items-center py-2">
                    <div className="flex items-center">
                      <FontAwesomeIcon icon={info.icon} className="text-gray-500 mr-3" />
      ...
      {activeModal === 'impersonateModal' && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div ref={modalRef} className="bg-white rounded-xl shadow-xl max-w-md w-full">
            ...
            <div className="p-6">
              <p className="mb-4">Enter the User ID or email of the user you want to impersonate:</p>
              <input
                type="text"
                id="userIdInput"
            ...
            <div className="flex justify-end gap-3 p-6 border-t">
              <button onClick={closeModal} className="px-5 py-2 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition-all">
                Cancel
              </button>
              <button onClick={executeImpersonation} className="px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all">
                Impersonate User
              </button>
            </div>
          </div>
      ...
      {activeModal === 'stopBookingsModal' && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div ref={modalRef} className="bg-white rounded-xl shadow-xl max-w-md w-full">
            ...
            <div className="p-6">
              <p className="mb-3"><strong>Warning:</strong> This action will immediately stop all booking functionality across the entire platform.</p>
              <p className="mb-3">Users will not be able to create new bookings, and vendors will not receive booking requests.</p>
            ...
            <div className="flex justify-end gap-3 p-6 border-t">
              ...
              <button onClick={() => executeOverride('stopBookings')} className="px-5 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all">
                Stop All Bookings
              </button>
            </div>
          </div>
          ...
          <div ref={modalRef} className="bg-white rounded-xl shadow-xl max-w-lg w-full">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Enter full name" />
              </div>
              <div>
                <label className="block font-semibold text-gray-900 mb-2">Email Address</label>
                <input type="email" className="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Enter email" />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block font-semibold text-gray-900 mb-2">User Type</label>
            ...
            <div className="flex justify-end gap-3 p-6 border-t">
              ...
              <button onClick={createUser} className="px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all">
                Create User
              </button>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div ref={modalRef} className="bg-white rounded-xl shadow-xl max-w-lg w-full">
            ...
            <div className="p-6">
              ...
              <div>
                <label className="block font-semibold text-gray-900 mb-2">Export Format</label>
                <select className="w-full px-4 py-2 border border-gray-300 rounded-lg">
                  <option>CSV</option>
                  <option>JSON</option>
            ...
            <div className="flex justify-end gap-3 p-6 border-t">
              ...
              <button onClick={exportData} className="px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all">
                Export Data
              </button>
            </div>
          </div>
      ...
      {activeModal === 'logoutModal' && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div ref={modalRef} className="bg-white rounded-xl shadow-xl max-w-md w-full">
            ...
            <div className="p-6">
              <p className="mb-3">Are you sure you want to logout from the Super Admin dashboard?</p>
            ...
            <div className="flex justify-end gap-3 p-6 border-t">
              ...
              <button onClick={logout} className="px-5 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all">
                Logout
              </button>
            </div>
          </div>
